            ...
            X
                ...
                <div className="modal-input">
                    <div className="input-block">
                        <label title={"track-title"} data-testid="input-title">
              Title
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="input-block">
                        <label title={"track-artist"} data-testid="input-artist">
              Artist
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="input-block">
                        <label title="track-album" data-testid="input-album">
              Album
                        </label>
                        <input
                            type="text"
                    ...
                    <div className="input-block">
                        <label title={"track-genres"} data-testid="genre-selector">
              Genres
                        </label>
                        <TagInput
                            tags={genres}
                    ...
                    <div className="input-block">
                        <label title={"track-cover-image"} data-testid="input-cover-image">
              Cover Image
                        </label>
                        <input
                            type="text"
