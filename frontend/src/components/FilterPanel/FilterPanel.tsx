...
const FilterPanel = ({ handleAddClick }: Props) => {
    ...
    const { setSearchValue, setFilters, resetFilters } = useFilterStore();
    ...
    return (
        <div className="filter-panel">
            ...
            <div
                className={`advanced-filter-panel-container ${isOpen ? "open" : ""}`}
            >
                <div className="advanced-filter-panel">
                    ...
                    <div className="input-container">
                        ...
                        <input
                            className="search-input"
                            type="number"
                            placeholder="Search by tracks to show"
                            value={limit}
                            step="5"
                    ...
                    <div className="advanced-filter-footer">
                        ...
                        <button className="add-button" onClick={applyFilters}>
                            Apply filters
                        </button>
                    </div>
                </div>
