...
const TrackList = (props: Props) => {
    ...
    const toggleAll = () => {
        if (selectedTracks.length === props.tracks.length) setSelectedTracks([]);
        else {
    ...
    const onBulkDelete = () => {
        if (selectedTracks.length > 0) props.handleBulkDelete(selectedTracks);
        else {
    ...
    return (
        <div className="track-list" onClick={handleClickOutside}>
            <div
                className={`all-selector ${selectedTracks.length === 0 ? "" : "active"} 
            ...
            {contextMenu.visible && (
                ...
                >
                    <ul className="context-menu-list">
                        ...
                        >
                            {selectedTracks.includes(contextMenu.trackId) ? "Undo" : "Select"}
                        </li>
